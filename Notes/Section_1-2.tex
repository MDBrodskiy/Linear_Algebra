...
\begin{itemize}
  ...
  \item Homogeneous Systems:
    ...
    \begin{enumerate}
      ...
      \item All constants are equal to zero

      \item Ex: $\begin{array}{l l} 2x_1-3x_2+x_3=0 \\ x_1-x_3 =0  \end{array}$

      \item $x_i=0$ is always a solution, and is called trivial (never inconsistent)

      \item If the number of variables in a homogeneous system is greater than the number of equations, then the system always has a nontrivial solution\footnote{Note: if the number of variables is less than or equal to the number of equations, then it may or may not have a nontrivial solution}
